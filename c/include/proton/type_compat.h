 ...
 *  PN_DEFINE_STDINT/PN_NODEFINE_STDINT   : turn on/off definition of int64_t
 * etc. PN_DEFINE_SSIZE_T/PN_NODEFINE_SSIZE_T : turn on/off definition of
 * ssize_t PN_INCLUDE_STDINT/PN_NOINCLUDE_STDINT : include (or not) stdint.h
 */
...
/* MBED_BUILD_TIMESTAMP is used to detect whether Proton is being built on
www.mbed.org with
