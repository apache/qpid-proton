...
PNX_EXTERN pn_handler_t *
pn_handler(void (*dispatch)(pn_handler_t *, pn_event_t *, pn_event_type_t));
PNX_EXTERN pn_handler_t *
pn_handler_new(void (*dispatch)(pn_handler_t *, pn_event_t *, pn_event_type_t),
...
PNX_EXTERN void pn_handler_dispatch(pn_handler_t *handler, pn_event_t *event,
...
PNX_EXTERN void pn_reactor_set_timeout(pn_reactor_t *reactor,
                                       pn_millis_t timeout);
...
PNX_EXTERN void pn_reactor_set_global_handler(pn_reactor_t *reactor,
                                              pn_handler_t *handler);
PNX_EXTERN pn_handler_t *pn_reactor_get_handler(pn_reactor_t *reactor);
PNX_EXTERN void pn_reactor_set_handler(pn_reactor_t *reactor,
                                       pn_handler_t *handler);
...
PNX_EXTERN void pn_reactor_update(pn_reactor_t *reactor,
                                  pn_selectable_t *selectable);
PNX_EXTERN pn_acceptor_t *pn_reactor_acceptor(pn_reactor_t *reactor,
                                              const char *host,
                                              const char *port,
                                              pn_handler_t *handler);
 ...
 */
PNX_EXTERN pn_connection_t *
pn_reactor_connection_to_host(pn_reactor_t *reactor, const char *host,
...
pn_reactor_get_connection_address(pn_reactor_t *reactor,
                                  pn_connection_t *connection);
...
PNX_EXTERN pn_task_t *pn_reactor_schedule(pn_reactor_t *reactor, int delay,
                                          pn_handler_t *handler);

PNX_EXTERN void pn_acceptor_set_ssl_domain(pn_acceptor_t *acceptor,
...
PNX_EXTERN pn_task_t *pn_timer_schedule(pn_timer_t *timer,
...
PNX_EXTERN pn_reactor_t *pn_class_reactor(const pn_class_t *clazz,
                                          void *object);
...
PNX_EXTERN void pn_record_set_handler(pn_record_t *record,
                                      pn_handler_t *handler);
