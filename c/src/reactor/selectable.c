...
PNX_EXTERN pn_iterator_t *pn_selectables(void) { return pn_iterator(); }
...
pn_selectable_t *pn_selectable(void) { return pn_selectable_new(); }
...
void pn_selectable_free(pn_selectable_t *selectable) { pn_decref(selectable); }
