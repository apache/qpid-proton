...
pn_transform_t *pn_transform() {
    ...
    pn_transform_t *transform =
        (pn_transform_t *)pn_class_new(&clazz, sizeof(pn_transform_t));
...
static bool pni_match_r(pn_matcher_t *matcher, const char *pattern,
                        const char *text, size_t group, size_t matched) {
    bool match;
...
static bool pni_match(pn_matcher_t *matcher, const char *pattern,
                      const char *text) {
    text = text ? text : "";
    matcher->groups = 0;
...
static size_t pni_substitute(pn_matcher_t *matcher, const char *pattern,
                             char *dest, size_t limit) {
    size_t result = 0;
