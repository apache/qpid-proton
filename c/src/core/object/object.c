...
int pn_void_inspect(void *object, pn_string_t *dst) {
    return pn_string_addf(dst, "%p", object);
}

const pn_class_t PN_VOID[] = {PN_METACLASS(pn_void)};

const char *pn_class_name(const pn_class_t *clazz) { return clazz->name; }

pn_cid_t pn_class_id(const pn_class_t *clazz) { return clazz->cid; }
...
#define pni_head(PTR) (((pni_head_t *)(PTR)) - 1)
...
void *pn_incref(void *object) { return pn_class_incref(PN_OBJECT, object); }

int pn_decref(void *object) { return pn_class_decref(PN_OBJECT, object); }

int pn_refcount(void *object) { return pn_class_refcount(PN_OBJECT, object); }

void pn_free(void *object) { pn_class_free(PN_OBJECT, object); }
...
bool pn_equals(void *a, void *b) { return !pn_compare(a, b); }
...
static const pn_class_t *pn_weakref_reify(void *object) { return PN_WEAKREF; }
