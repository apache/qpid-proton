...
/* EXAMPLE USE ONLY. Simulate the subset of POSIX threads used by examples for
 * windows */
...
static int pthread_create(pthread_t *t, void *unused, void *(*f)(void *),
                          void *arg) {
    t->func = f;
    t->arg = arg;
...
#define pthread_mutex_init(m, unused)                                          \
