...
class SslTest(common.Test):
    ...
    def test_certificate_fingerprint_and_subfields(self):
        ...
        self.assertIsNone(client.ssl.get_cert_fingerprint(21, SSL.SHA1)) # Should be at least 41
        self.assertIsNone(client.ssl.get_cert_fingerprint(50, SSL.SHA256)) # Should be at least 65
        self.assertIsNone(client.ssl.get_cert_fingerprint(128, SSL.SHA512)) # Should be at least 129
        self.assertIsNone(client.ssl.get_cert_fingerprint(10, SSL.MD5)) # Should be at least 33

        self.assertIsNotNone(client.ssl.get_cert_fingerprint(50, SSL.SHA1)) # Should be at least 41
        self.assertIsNotNone(client.ssl.get_cert_fingerprint(70, SSL.SHA256)) # Should be at least 65
        self.assertIsNotNone(client.ssl.get_cert_fingerprint(130, SSL.SHA512)) # Should be at least 129
        self.assertIsNotNone(client.ssl.get_cert_fingerprint(35, SSL.MD5)) # Should be at least 33
