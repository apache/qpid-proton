...
public final class Data implements Section, Encodable
{
    public final static long DESCRIPTOR_LONG = 0x0000000000000075L;

    public final static String DESCRIPTOR_STRING = "amqp:data:binary";
