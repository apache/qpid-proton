...
class FrameParser2 implements TransportInput
{
    ...
    private final FrameHandler2 _frameHandler;
    private final ByteArrayDecoder _decoder;
    ...
    private TransportFrame2 _heldFrame;
    ...
    FrameParser2(FrameHandler2 frameHandler, ByteArrayDecoder decoder, int maxFrameSize)
    {
                    ...
                    try
                    {
                        ...
                        if (frameBodySize > 0)
                        {
                            ...
                            if(obj instanceof Performative)
                            {
                                ...
                                {
                                    TRACE_LOGGER.log(Level.FINE, "IN: CH["+channel+"] : " + performative + (payloadBytes == null ? "" : "[" + payloadBytes.length + "]"));
                                }
                                TransportFrame2 frame = new TransportFrame2(channel, performative, payloadBytes);
