...
public final class SaslResponse implements Encodable, SaslBody
{
    public final static long CODE = 0x0000000000000043L;

    public final static String DESCRIPTOR = "amqp:sasl-response:list";
