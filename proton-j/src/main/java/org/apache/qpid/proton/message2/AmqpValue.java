...
public final class AmqpValue implements Section, Encodable
{
    public final static long DESCRIPTOR_LONG = 0x0000000000000077L;

    public final static String DESCRIPTOR_STRING = "amqp:amqp-value:*";
