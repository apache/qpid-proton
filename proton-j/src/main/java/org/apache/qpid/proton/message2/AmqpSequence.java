...
public final class AmqpSequence implements Section, Encodable
{
    public final static long DESCRIPTOR_LONG = 0x0000000000000076L;

    public final static String DESCRIPTOR_STRING = "amqp:amqp-sequence:list";
    ...
    public static final class Factory implements DescribedTypeFactory
    {
        ...
        {
            return new AmqpSequence((List<Object>) in);
        }
    }
