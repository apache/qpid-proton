 ...
 * @param[in] ssl the ssl client/server to query
 * @param[in] unsigned fingerprint char pointer. The certificate fingerprint (in hex format) will be populated in this array.
 ...
 *                      unsigned char *fingerprint will contain the appropriate hex fingerprint
 */
 ...
 */
PN_EXTERN const unsigned char* pn_ssl_get_remote_subject_subfield(pn_ssl_t *ssl0, pn_ssl_cert_subject_subfield field);
